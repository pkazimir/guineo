  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <ul class="nav navbar-nav navbar-right hidden-xs hidden-sm">
          <li <?php if ($screen=='profile') echo 'class="active active-color"'; ?>><a href="/guineo/perfil"><span class="glyphicon glyphicon-user"></span> <?php echo $username; ?>@brugal.com.do</a></li>
        </ul>
    </div>
  </div>
</nav>