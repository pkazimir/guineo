...
<?php foreach ($fact_list as $row): ?>    
    ...
    <tr>
        ...
        <td><a href="uploads/<?php echo $row['fact_id']; ?>.<?php echo $row['ext']; ?>" class="btn btn-sm btn-success" target="_blank"><span class="glyphicon glyphicon-ok"></span></a></td>
        <td><a href="uploads/<?php echo $row['fact_id']; ?>.<?php echo $row['ext']; ?>" class="btn btn-sm btn-danger" target="_blank"><span class="glyphicon glyphicon-remove"></span></a></td>
    </tr>
